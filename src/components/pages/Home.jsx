  ...
  return (
    <>
      <div className="h-auto relative">
        <section className="mt-16 pb-48 w-full flex flex-col items-center justify-center font-mono sm:flex-row md:pb-20 ">
          ...
          <button className="absolute text-sm bottom-48 right-2 px-4 py-2 z-2 bg-midPurple hover:bg-darkPurple rounded-3xl text-white sm:text-base sm:bottom-24 sm:right-10 ">
            Portfolio
          </button>
        </section>
        <Footer />
